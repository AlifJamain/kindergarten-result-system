...
$sql="update tblkeputusan2  set marks=:mrks where id=:iid ";
	...
	<div class="row">
		...
		<div class="col-xs-8">
            <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Kemaskini Penilaian Psikomotor</legend>
...
$ret = "SELECT tblpelajar.nama_pelajar,tblkelas.nama_kelas from tblkeputusan2 join tblpelajar on tblkeputusan2.id_pelajar=tblkeputusan2.id_pelajar join tblpsikomotor on tblpsikomotor.id=tblkeputusan2.id_psikomotor join tblkelas on tblkelas.id=tblpelajar.id_kelas where tblpelajar.id_pelajar=:stid limit 1";
...
<?php } }?>
<?php 
$sql = "SELECT distinct tblpelajar.nama_pelajar,tblpelajar.id_pelajar,tblkelas.nama_kelas,tblpsikomotor.nama_psikomotor,tblkeputusan2.marks,tblkeputusan2.id as resultid from tblkeputusan2 join tblpelajar on tblpelajar.id_pelajar=tblkeputusan2.id_pelajar join tblpsikomotor on tblpsikomotor.id=tblkeputusan2.id_psikomotor join tblkelas on tblkelas.id=tblpelajar.id_kelas where tblpelajar.id_pelajar=:stid ";
$query = $dbh->prepare($sql);
...
{  ?>
<div class="form-group">
                                <label class="col-md-4 control-label"><?php echo htmlentities($result->nama_psikomotor)?></label>
                                <div class="col-md-8 inputGroupContainer">
