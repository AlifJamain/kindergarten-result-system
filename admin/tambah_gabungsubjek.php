...
$subjek=$_POST['subjek']; 
$status=1;
$sql="INSERT INTO  tblgabung(id_kelas,id_subjek,status) VALUES(:kelas,:subjek,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':kelas',$kelas,PDO::PARAM_STR);
$query->bindParam(':subjek',$subjek,PDO::PARAM_STR);
...
<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <select name="subjek" class="form-control" id="default" required="required">
<option value="">Select Subject</option>
<?php $sql = "SELECT * from tblsubjek";
$query = $dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
if($query->rowCount() > 0)
...
foreach($results as $result)
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->nama_subjek); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
