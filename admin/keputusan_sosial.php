...
<html lang="en">
 ...
 ['id','marks'],
 <?php 
			$query = "SELECT * from tblkeputusan3 ";
...
<td colspan="3" align="center"><button id="printPageButton" class="btn btn-primary" onClick="window.print();">Cetak</button>&nbsp;<button onclick="location.href = 'keputusan_papar_sosial.php';" id="printPageButton" class="btn btn-danger" >Balik</button></td>
