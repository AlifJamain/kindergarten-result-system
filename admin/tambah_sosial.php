...
$sosial=$_POST['sosial']; 
$status=1;
$sql="INSERT INTO  tblgabung3(id_kelas,id_sosial,status) VALUES(:kelas,:sosial,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':kelas',$kelas,PDO::PARAM_STR);
$query->bindParam(':sosial',$sosial,PDO::PARAM_STR);
...
<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <select name="sosial" class="form-control" id="default" required="required">
<option value="">Select Subject</option>
<?php $sql = "SELECT * from tblsosial";
$query = $dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
if($query->rowCount() > 0)
...
foreach($results as $result)
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->nama_sosial); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
