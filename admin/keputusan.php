...
<html lang="en">
 ...
 ['id','marks'],
 <?php 
			$query = "SELECT * from tblkeputusan ";
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Penilaian Keseluruhan Pelajar</h3>
                                                    <hr />
<?php
// code Student Data
...
<?php                                              
// Code for result
 $query ="select t.nama_pelajar,t.id_kelas,t.marks,id_subjek,tblsubjek.nama_subjek from (select sts.nama_pelajar,sts.id_kelas,tr.marks,id_subjek from tblpelajar as sts join  tblkeputusan as tr on tr.id_pelajar=sts.id_pelajar) as t join tblsubjek on tblsubjek.id=t.id_subjek where (t.nama_pelajar=:nama_pelajar and t.id_kelas=:id_kelas)";
...
<td style="text-align: center"><?php echo htmlentities($result->nama_subjek);?></td>
...
<tr>
 ...
 <?php } else { ?>     
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Notice!</strong> Penilaian belum dilaksana
 <?php }
?>
                                        </div>
 <?php 
...
<?php                                              
// Code for result
 $query ="select t.nama_pelajar,t.id_kelas,t.marks,id_sosial,tblsosial.nama_sosial from (select sts.nama_pelajar,sts.id_kelas,tr.marks,id_sosial from tblpelajar as sts join  tblkeputusan3 as tr on tr.id_pelajar=sts.id_pelajar) as t join tblsosial on tblsosial.id=t.id_sosial where (t.nama_pelajar=:nama_pelajar and t.id_kelas=:id_kelas)";
$query= $dbh -> prepare($query);
$query->bindParam(':nama_pelajar',$nama_pelajar,PDO::PARAM_STR);
$query->bindParam(':id_kelas',$id_kelas,PDO::PARAM_STR);
$query-> execute();  
...
foreach($results as $result){
    ...
    ?>
                                                		...
                                                		<tr>
<th scope="row" style="text-align: center"><?php echo htmlentities($cnt);?></th>
<td style="text-align: center"><?php echo htmlentities($result->nama_sosial);?></td>
<td style="text-align: center"><?php echo htmlentities($totalmarks=$result->marks);?></td>
                                                		</tr>
<?php 
$totlcount+=$totalmarks;
...
<td colspan="3" align="center"><button id="printPageButton" class="btn btn-primary" onClick="window.print();">Cetak</button>&nbsp;<button onclick="location.href = 'keputusan_papar.php';" id="printPageButton" class="btn btn-danger" >Balik</button></td>
