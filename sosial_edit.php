...
$sql="update tblkeputusan3  set marks=:mrks where id=:iid ";
	...
	<div class="row">
		...
		<div class="col-xs-8">
            <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Kemaskini Penilaian Sosial</legend>
...
$ret = "SELECT tblpelajar.nama_pelajar,tblkelas.nama_kelas from tblkeputusan3 join tblpelajar on tblkeputusan3.id_pelajar=tblkeputusan3.id_pelajar join tblsosial on tblsosial.id=tblkeputusan3.id_sosial join tblkelas on tblkelas.id=tblpelajar.id_kelas where tblpelajar.id_pelajar=:stid limit 1";
...
<?php } }?>
<?php 
$sql = "SELECT distinct tblpelajar.nama_pelajar,tblpelajar.id_pelajar,tblkelas.nama_kelas,tblsosial.nama_sosial,tblkeputusan3.marks,tblkeputusan3.id as resultid from tblkeputusan3 join tblpelajar on tblpelajar.id_pelajar=tblkeputusan3.id_pelajar join tblsosial on tblsosial.id=tblkeputusan3.id_sosial join tblkelas on tblkelas.id=tblpelajar.id_kelas where tblpelajar.id_pelajar=:stid ";
$query = $dbh->prepare($sql);
...
{  ?>
<div class="form-group">
                                <label class="col-md-4 control-label"><?php echo htmlentities($result->nama_sosial)?></label>
                                <div class="col-md-8 inputGroupContainer">
...
<?php }} ?> 
<div class="form-group">
            <button class="btn btn-primary" type="submit" name="update">Kemaskini</button>&nbsp;<a href='sosial_papar.php' class='btn btn-danger'>Balik</a>
</div>
