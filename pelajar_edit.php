	...
	<div class="row">
		...
		<div class="col-xs-8">
            <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Kemaskini Maklumat Pelajar</legend>
...
{  ?>   
                          <fieldset>
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8 inputGroupContainer">
                                   <div class="input-group"><span class="input-group-addon"><input id="tarikh_lahir_pelajar" name="tarikh_lahir_pelajar" class="form-control" required="true" value="<?php echo htmlentities($result->tarikh_lahir_pelajar);?>" type="text"></span></div>
                                </div>
                             </div>
                              <div class="form-group">
                                <label class="col-md-4 control-label">Tarikh Daftar</label>
                                <div class="col-md-8 inputGroupContainer">
                                   <div class="input-group"><span class="input-group-addon"><input id="tarikh_daftar_tadika" name="tarikh_daftar_tadika" class="form-control" required="true" value="<?php echo htmlentities($result->tarikh_daftar_tadika);?>" type="text"></span></div>
                                </div>
                             </div>
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8 inputGroupContainer">
                                   <div class="input-group"><span class="input-group-addon"><input id="jantina_pelajar" name="jantina_pelajar" class="form-control" required="true" value="<?php echo htmlentities($result->jantina_pelajar);?>" type="text"></span></div>
                                </div>
                             </div>
                              <div class="form-group">
            ...
            <option value="Penjaga">Penjaga</option>
             ...
             <button class="btn btn-primary" type="submit" name="update" onclick="myFunction()">Kemaskini</button>&nbsp;<a href='pelajar_papar.php' class='btn btn-danger'>Balik</a>
</div>
<script>
function myFunction() {
