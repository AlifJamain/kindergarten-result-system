...
$mark=$_POST['marks'];
 ...
 $stmt = $dbh->prepare("SELECT tblpsikomotor.nama_psikomotor,tblpsikomotor.id FROM tblgabung2 join  tblpsikomotor on  tblpsikomotor.id=tblgabung2.id_psikomotor WHERE tblgabung2.id_kelas=:cid order by tblpsikomotor.nama_psikomotor");
...
$mar=$mark[$i];
$sid=$sid1[$i];
$sql="INSERT INTO  tblkeputusan2(id_pelajar,id_kelas,id_psikomotor,marks, empid) VALUES(:studentid,:class,:sid,:marks, :empid)";
...
<?php }} ?>
                ...
                <div class="form-group">
            <button class="btn btn-primary" type="submit" name="add" onclick="myFunction()">Tambah</button>&nbsp;<a href='psikomotor_papar.php' class='btn btn-danger'>Balik</a>
    <script>
function myFunction() {
